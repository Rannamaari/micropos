...
class SupplierResource extends BaseResource
{
    ...
    protected static ?string $viewPermission = 'suppliers.view';

    protected static ?string $createPermission = 'suppliers.create';

    protected static ?string $updatePermission = 'suppliers.update';
